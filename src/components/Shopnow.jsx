    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center z-20 relative pt-10">
          <Link
  href="/store"
  className="group inline-flex items-center pt-20 px-8 py-4 md:px-10 md:py-5 bg-transparent border-2 border-black text-black font-semibold text-lg md:text-xl rounded-full hover:bg-black hover:text-white transition-all duration-300 transform hover:scale-105 hover:shadow-xl"
>
