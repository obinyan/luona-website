...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-gray-50 to-white overflow-hidden pt-6 pd-20">
      ...
      <div className="relative z-10 container mx-auto px-3 sm:px-4 lg:px-6 min-h-screen flex flex-col justify-center items-center">
        ...
        {/* Top Heading - inline */}
        <div className="flex items-center justify-center mb-4 md:mb-16 space-x-3">
        ...
        {/* Slideshow */}
        <div className="relative w-full max-w-4xl mb-4 md:mb-16">
